...
export function validateIndex(publications) {
  ...
  // `publications` n'est PAS supposé trié ici (validateIndex est exportée et
  // appelable seule, notamment par le futur mergeIndex de la tâche 2) : on
  // calcule donc premiere/derniere sur une copie triée, sans muter l'argument.
