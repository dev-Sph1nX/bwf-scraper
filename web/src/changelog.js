...
export const CHANGELOG = [
  {
    ...
    items: [
      ...
      { type: "feat", text: "Accueil : filtres par tournoi et par tableau (qualifications comprises, mêmes libellés que la page tournoi), en plus du filtre avec/sans cote. Le choix des opérateurs passe dans un menu ⋮ « préférences d'affichage »." },
      { type: "feat", text: "Santé des données : visionneuse JSON intégrée — le contenu réel de chaque fichier ET de chaque relevé bookmaker, brut et dépliable (+ lien vers le fichier tel que servi)." },
