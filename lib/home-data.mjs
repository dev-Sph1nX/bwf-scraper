...
export function oddsForMatch(group, swapped) {
  ...
  // L'heure de départ vient des bookmakers (le flux BWF ne la donne presque
  // jamais) : elle sert à l'affichage ET au tri horaire de l'accueil.
  return { bookKey: group.key, n, books, startUtc: group.startUtc ?? null };
}
