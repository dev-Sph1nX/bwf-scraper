...
// (et non « Plus/Moins de … » comme supposé d'abord — c'est ce qui a fait
// rater les premiers relevés). Le parseur garde aussi les autres formes
// plausibles — labels « Plus/Moins de 75,5 », ou un marché par barre
// (« Total de points 75,5 », labels nus, barre en fin de nom) — car le
// libellé peut varier. Les totaux PAR SET (« 1er set - Nombre total de
// points ») sont écartés par le mot « set » dans le nom.
 ...
 */
export async function enrichBetclicSets(rows, _ctx, { pauseMs = 600, maxMatches = 57, baseUrl = PAGE_URL } = {}) {
  let n = 0;
